...
namespace Ferreteria
{
    public partial class LoteForm : Form
    {
        ...
        private Lote ObtenerCampos()
        {
            ...
            //obtener mask
            lot.FechaIngresoLote = DateTime.Parse(mskFechaIngreso.Text);
            lot.FechaVencimientoLote = DateTime.Parse(mskFechaVencimiento.Text);
            lot.CantidadArticulosLote = int.Parse(mskCantidadArticulos.Text.Trim());

            //obtener combos
            lot.CodArticuloLote = (int)cbCodArticulo.SelectedValue;
            lot.CodProveedorLote = (int)cbCodProveedor.SelectedValue;
        ...
        private void btnAgregarLote_Click_1(object sender, EventArgs e)
        {
            ...
            bool insert = AD_Lote.AgregarLoteBD(lot);
        ...
        //{
        //    if (mskFechaIngreso.Text.Trim().Equals("") || mskFechaVencimiento.Text.Trim().Equals("") || txtCantidadArticulos.Text.Trim().Equals("") || txtCodigoProveedor.Text.Trim().Equals(""))
        //    {
        ...
        {
            cbCodArticulo.DataSource = AD_Lote.ObtenerCodArticulo();
        ...
        {
            cbCodProveedor.DataSource = AD_Lote.ObtenerCodProveedor();
            cbCodProveedor.DisplayMember = "codProveedor";
        ...
        {
            dgLotes.DataSource = AD_Lote.ObtenerLotes();

        } // ***

        private void btnEliminarLote_Click_1(object sender, EventArgs e)
        {
            LimpiarCamposFormularioLote();
        } // ****
        ...
        //{
        //    mskFechaIngreso.Text = lot.FechaIngresoLote;
        //    mskFechaVencimiento.Text = lot.FechaVencimientoLote;
        ...
        //    if (mskFechaIngreso.Text.Trim().Equals(""))
        //    {
